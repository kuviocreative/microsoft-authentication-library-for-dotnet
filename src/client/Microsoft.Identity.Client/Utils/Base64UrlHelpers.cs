...
namespace Microsoft.Identity.Client.Utils
{
    internal static class Base64UrlHelpers
    {
        ...
        internal unsafe static string FastEncode(string str)
        {
    ...
    static class WebEncoders
    {
        ...
        private static class EncoderResources
        {
            /// <summary>
        ...
        public static string Base64UrlEncode(ReadOnlySpan<byte> input)
        {
            ...
            Span<char> buffer = bufferSize <= StackAllocThreshold
                ...
                : bufferToReturnToPool = System.Buffers.ArrayPool<char>.Shared.Rent(bufferSize);
            ...
            {
                System.Buffers.ArrayPool<char>.Shared.Return(bufferToReturnToPool);
            }
